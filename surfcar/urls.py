...
urlpatterns = [
    ...
    url(r'^feeds/', include('surfcar.feeds.urls')),
    url(r'^questions/', include('surfcar.questions.urls')),
    url(r'^articles/', include('surfcar.articles.urls')),
    url(r'^messages/', include('surfcar.messenger.urls')),
